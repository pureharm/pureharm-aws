...
trait AmazonS3Client[F[_]] {
  ...
  def list(bucket: S3Bucket, prefix: S3KeyPrefix): F[List[S3FileKey]]
...
object AmazonS3Client {
  ...
  private class AmazonS3ClientImpl[F[_]](
    ...
    override def list(bucket: S3Bucket, prefix: S3KeyPrefix): F[List[S3FileKey]] =
  ...
  private class AmazonS3ClientForBucketImpl[F[_]](
    ...
    override def list(prefix: S3KeyPrefix): F[List[S3FileKey]] =
