...
/**
  ...
  * its id, required for the [[busymachines.pureharm.aws.cloudfront.CloudfrontKeyPairID]]. Additionally, make sure you have the
  * private key file stored somewhere on your hard-drive, specified using the
